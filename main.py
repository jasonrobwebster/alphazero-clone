...
print(game.board())
print()
net = AlphaZeroNet(game, blocks=10, epochs=10, save_path='./models/pytorch/othello.model')
net.build()
player = NetPlayer(game, net)
mcts = MCTSNet(game, player=player, episodes=100, exploration=0.7)
#mcts = MCTS(game, episodes=100)
max_moves = 100

coach = NetCoach(mcts, net, episodes=100, buffer=10, max_moves=max_moves, train_time=64*60*60, prop_thresh=12, train_kw={'epochs': 10})
