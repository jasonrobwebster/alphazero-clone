...
print(game.board())
print()
net = AlphaZeroNet(game, blocks=10, epochs=10, save_path='./models/keras/chess.model')
net.build()
...
coach = NetCoach(mcts, net, episodes=200, buffer=50, max_moves=max_moves, train_time=8*60*60, prop_thresh=30, train_kw={'epochs': 10})
